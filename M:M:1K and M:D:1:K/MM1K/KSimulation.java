...
public class KSimulation { 
    ...
    public static KCalendar calendar = new KCalendar();
    public static Queue<KCustomer> queue = new LinkedList<KCustomer>();
    public static Queue<KCustomer> finishedEvents = new LinkedList<KCustomer>();
 ...
 // Print Results
    private static void printStats(double lambda, double Ts) {
        ...
        while(!finishedEvents.isEmpty()) {
            KCustomer temp = finishedEvents.poll(); 
    ...
    public static void main(String[] args)  {
        ...
        //first customer
        KCustomer first = new KCustomer(0, "Birth");
        calendar.Enqueue(first);
  
        // START MONITORING
        KCustomer initMoniter = new KCustomer(100, "Monitor");
        calendar.Enqueue(initMoniter);
  
        while(globalClock <= warmUpTime) {
            KCustomer c = calendar.Dequeue();
            globalClock = c.time;
            c.processor();
        }
